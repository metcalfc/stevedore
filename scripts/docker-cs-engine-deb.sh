...
curl -f "https://${PACKAGECLOUD_TOKEN}:@packagecloud.io/install/repositories/Docker/cs/config_file.list?os=${os}&dist=${dist}&name=${host}" > $apt_source_path
curl_exit_code=$?

if [ "$curl_exit_code" = "22" ]; then
  echo -n "Unable to download repo config from: "
  echo "https://${PACKAGECLOUD_TOKEN}:@packagecloud.io/install/repositories/Docker/cs/config_file.list?os=${os}&dist=${dist}&name=${host}"
  echo
  ...
  echo "    curl https://${PACKAGECLOUD_TOKEN}:@packagecloud.io/install/repositories/Docker/cs/config_file.list?os=${os}&dist=${dist}&name=${host}"
